...
from parsing.parsing import parse_args, default_config, STEAD_config_db
...
def train(config): 
    ...
    trainer = TrainerDualBranch(
        ...
        test_loader= dataset.test_loader if (config.conditional or config.predict_pga) else None,
        lr = config.lr,
